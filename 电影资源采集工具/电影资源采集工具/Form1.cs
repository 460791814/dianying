...
namespace 电影资源采集工具
{
    public partial class Form1 : Form
    {
        ...
        public void GetList(object obj)
        {
            ...
            string str = HttpTool.GetHtml("http://dianying.fm/waterfall/class_tv?page=" + page, new CookieContainer());
            if (jilu == page)
            {
                chongfu++;
            }
            ...
            if (!string.IsNullOrEmpty(str))
            {
                ...
                if (r.IsMatch(str))
                {
                    ...
                    {
                        if (item.Groups[1].Value.Contains("movie/"))
                        {
            ...
            if (this.listLog.Items.Count > 100)
            {
               ...
               Msg("开始抓取page"+page);
               if (fangsha >Convert.ToInt32( this.textBox2.Text))
               {
